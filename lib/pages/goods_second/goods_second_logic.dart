...
import '../goods_first/goods_first_logic.dart';

class GoodsSecondLogic extends GetxController {

  DBGoods dbGoods = Get.find();

  cleanGoodsData() async {
  ...
  aboutGoodsPrivacy(BuildContext context) async {
...
If you have any questions or concerns about our privacy policy, please contact us via email.
  ...
  aboutGoodsUS(BuildContext context) async {
    ...
    showAboutDialog(
      ...
      children: [
        const Text(
            """We can keep track of your items"""),
      ],
      context: context,
    );
  }
